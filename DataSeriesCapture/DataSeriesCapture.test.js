...
describe('DataSeriesCapture', () => {
    ...
    it('can initialize basic statistics (mean, min, max) using the .build_stats( ) method', () => {
        capture.add(1);
        capture.add(2);
        capture.add(3);
    ...
    it('.read_pressure_from_csv(csvData) sets isCSV === true, and pushes CSV pressure data to this.dataSeries.', async () => {
